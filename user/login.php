...
if(isset($_POST['submit']))
{
    ...
    else
    {
		...
		if($email=='pgp17amitsingh@imt.ac.in' ||$email=='pgp17niharikasuneja@imt.ac.in')
         {
			$error= "Your team has been disqualified from the chakravyuh fantasy league, as we have found that you submitted your team after the voting process began.";
		}
		else{
        // Selecting Database
...
<html>
    <head>
		...
		<title>Login | Chakravyuh Fantasy League</title>
    ...
    <style>
        .logo-view{border-bottom: 1px solid #cec9c9;text-align: center;}
    </style>
    <body>
