...
$pricesql = "select price,SEX from player where SNO='$playerid'";
...
$amountsql = "select amount,male,team from user where SNO='$userid'";
...
$remainingmale=$amount['male']-$malecount;
$remainingteam=$amount['team']-1;
...
$updatesql = "UPDATE user SET amount='$remainingamount',male='$remainingmale', team='$remainingteam' where SNO='$userid'";
